  ...
  const sendEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await emailjs.sendForm(
        'service_7b70lei', // Replace with your service ID
        'template_4x8swa4', // Replace with your template ID
        form.current,
        'nPKpf2kZ3VIMvkfS4' // Replace with your public key
      );
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 placeholder-gray-400 placeholder:italic"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-6 rounded-lg hover:from-blue-400 hover:to-blue-500 hover:scale-105 transition-all duration-200 font-medium shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {isLoading ? (
              ...
              <div className="mt-4 text-center">
                <p className="text-xs text-gray-400">
                  Contact form implemented using{' '}
                  <a 
